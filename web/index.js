...
import applySocialMideaIconsApiEndpoints from "./middleware/social-midea-icon-api.js";
...
SocialMideaIconDb.db = sessionDb.db;
SocialMideaIconDb.init();
...
export async function createServer(
  ...
  applySocialMideaIconsApiEndpoints(app);
